...
public class UIControls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currentMenu == 2)
        {
            ...
            if (Input.GetKeyDown(KeyCode.Keypad6) && nom == "Brightness")
            {
            ...
            else if (Input.GetKeyDown(KeyCode.Keypad4) && nom == "Brightness")
            {
                int counter = int.Parse(optionsM3[selectedOption].transform.Find("Counter").gameObject.GetComponent<Text>().text);
                counter--;
                if (counter >= 0)
            ...
            else if (nom == "Resolution" && Input.GetKeyDown(KeyCode.Keypad5))
            {
                Debug.Log("dd");
            ...
            else if (nom == "Window Mode" && Input.GetKeyDown(KeyCode.Keypad5))
            {
